package uk.gov.justice.services.cakeshop.cakeshop.it.params;

import static uk.gov.justice.services.cakeshop.cakeshop.it.helpers.SystemPropertyFinder.findWildflyHttpPort;
...
public class CakeShopUris {
    ...
    public static final String HEALTHCHECK_URI = HOST + "/example-service/internal/healthchecks/all";
