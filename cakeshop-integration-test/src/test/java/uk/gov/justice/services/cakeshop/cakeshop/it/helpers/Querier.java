...
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopMediaTypes.QUERY_CAKES_MEDIA_TYPE;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopMediaTypes.QUERY_INDEX_MEDIA_TYPE;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopMediaTypes.QUERY_ORDER_MEDIA_TYPE;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopMediaTypes.QUERY_RECIPES_MEDIA_TYPE;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopMediaTypes.QUERY_RECIPE_MEDIA_TYPE;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopUris.CAKES_RESOURCE_QUERY_URI;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopUris.INDEXES_RESOURCE_QUERY_URI;
import static uk.gov.justice.services.cakeshop.cakeshop.it.params.CakeShopUris.ORDERS_RESOURCE_QUERY_URI;
