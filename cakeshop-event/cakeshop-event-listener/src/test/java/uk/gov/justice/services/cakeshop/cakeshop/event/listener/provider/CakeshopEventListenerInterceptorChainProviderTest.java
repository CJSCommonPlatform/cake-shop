...
public class CakeshopEventListenerInterceptorChainProviderTest {

    @Test
    public void shouldCreateInterceptorChainEntriesWithSubscriptionEventInterceptor() {

        final List<InterceptorChainEntry> interceptorChainEntries = new CakeshopEventListenerInterceptorChainProvider().interceptorChainTypes();
