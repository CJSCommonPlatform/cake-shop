...
public class CakeshopCommandHandlerInterceptorChainProvider implements InterceptorChainEntryProvider {

    private final List<InterceptorChainEntry> interceptorChainEntries = new ArrayList<>();

    public CakeshopCommandHandlerInterceptorChainProvider() {
