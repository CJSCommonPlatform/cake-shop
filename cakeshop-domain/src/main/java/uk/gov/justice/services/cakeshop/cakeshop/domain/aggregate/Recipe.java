package uk.gov.justice.services.cakeshop.cakeshop.domain.aggregate;
...
import uk.gov.justice.services.cakeshop.cakeshop.domain.Ingredient;
import uk.gov.justice.services.cakeshop.cakeshop.domain.event.CakeMade;
import uk.gov.justice.services.cakeshop.cakeshop.domain.event.RecipeAdded;
import uk.gov.justice.services.cakeshop.cakeshop.domain.event.RecipePhotographAdded;
import uk.gov.justice.services.cakeshop.cakeshop.domain.event.RecipeRemoved;
import uk.gov.justice.services.cakeshop.cakeshop.domain.event.RecipeRenamed;
